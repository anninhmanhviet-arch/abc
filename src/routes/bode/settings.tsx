  ...
  return (
    <AdminShell>
      ...
      <div className="grid max-w-lg gap-3">
        ...
        <div className="space-y-1.5"><Label>% hoa hồng affiliate (trên nạp thành công)</Label><Input value={s.affiliate_rate ?? "10"} onChange={(e) => set("affiliate_rate", e.target.value)} /></div>
        <div className="flex items-center justify-between rounded-md border border-border p-3">
          <Label>Bật affiliate</Label>
          <Switch checked={s.affiliate_enabled !== "false"} onCheckedChange={(c) => set("affiliate_enabled", c ? "true" : "false")} />
        </div>
        <div className="flex items-center justify-between rounded-md border border-border p-3">
