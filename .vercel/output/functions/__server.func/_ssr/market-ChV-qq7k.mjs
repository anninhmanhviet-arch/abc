...
import { a as n } from "./core-hltlGHwq.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/market-ChV-qq7k.js
...
var getPublicTicker = createServerFn({ method: "GET" }).handler(createSsrRpc("1e0fc11083a0ee40cf47eeea41ab3889b24373a1bcb2b3d39caefffccfe4b901"));
var getMarket = createServerFn({ method: "GET" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("8f53fed23113f3a35963c94020d6cb20d801ce9b0f3be414229c67d4a27f3605"));
var getAdminMarket = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("99b3623b1a00653f7aedf98ccbfc73af8c9c98fc683aecd170f1de888fc1773b"));
...
})).handler(createSsrRpc("faeed0ff9674c86d55458d9d41fd1cddf9d3561980e0807946942e079373162c"));
var setUpRatio = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator(object({
	assetId: number(),
	upRatio: number().min(0).max(100)
})).handler(createSsrRpc("dfa4dcbec9e268bcec48b88b5ebfc20e38af2d8ad1adeeef8cbb3b5358949582"));
//#endregion
export { setUpRatio as a, getPublicTicker as i, getAdminMarket as n, syncAll as o, getMarket as r, forceCandle as t };
